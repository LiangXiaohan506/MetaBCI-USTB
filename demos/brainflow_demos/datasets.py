...
filepath_mi = "data\\MI\\test"
filepath_mi_train = "data\\MI\\train"
filepath_mi_test = "data\\MI\\test"
# 数据的相对路径
filepath_ssvep = "data\\ssvep"
MetaBCIData_URL = {
    'imagery': os.path.join(os.path.dirname(__file__), filepath_mi),
    'imagery_train': os.path.join(os.path.dirname(__file__), filepath_mi_train),
    'imagery_test': os.path.join(os.path.dirname(__file__), filepath_mi_test),
